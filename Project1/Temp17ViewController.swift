...
class Temp17ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
     ...
     @IBAction func showButton() {
        let index = pickerView.selectedRow(inComponent: 0)
         ...
         else if sortArray[index] == "상의"
         {
             ...
             imageLeft.image = UIImage(named: "flimsyknit.png")
            imageRight.image = UIImage(named: "mantoman.png")
             labelLeft.text = "얇은 니트"
            labelRight.text = "맨투맨"
