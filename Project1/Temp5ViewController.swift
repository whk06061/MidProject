...
class Temp5ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBOutlet var pickerView: UIPickerView!
     ...
     @IBAction func showButton() {
        let index = pickerView.selectedRow(inComponent: 0)
         ...
         {  imageLeft.image = UIImage(named: "coat.png")
            imageRight.image = UIImage(named: "leatherjacket.png")
             labelLeft.text = "코트"
            labelRight.text = "가죽자켓"
         ...
         else if sortArray[index] == "상의"
         {
            ...
            imageCenter.image = UIImage(named: "knit.png")
            labelCenter.text = "니트"
            viewLeft.isHidden = true
