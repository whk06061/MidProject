//
//  Temp28ViewController.swift
//  Project1
//
//  Created by Mac SWU on 2020/05/02.
//  Copyright © 2020 Mac SWU. All rights reserved.
//

import UIKit

class Temp28ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBAction func showButton() {
       let index = pickerView.selectedRow(inComponent: 0)
        ...
        {
            imageLeft.image = UIImage(named: "sleeveless.png")
            imageRight.image = UIImage(named: "tshirts.png")
            labelLeft.text = "민소매"
            labelRight.text = "반팔"
        ...
        else if sortArray[index] == "하의"
        {
            ...
            imageCenter.image = UIImage(named: "shortpants.png")
            labelCenter.text = "반바지"
            viewLeft.isHidden = true
            viewCenter.isHidden = false
            viewRight.isHidden = true
        }
        else if sortArray[index] == "기타"
               {
                   ...
                   imageCenter.image = UIImage(named: "dress.png")
                   labelCenter.text = "원피스"
                   viewLeft.isHidden = true
                   viewCenter.isHidden = false
                   viewRight.isHidden = true
               }
