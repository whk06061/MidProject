...
class Temp9ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBOutlet var pickerView: UIPickerView!
     ...
     @IBAction func showButton() {
        let index = pickerView.selectedRow(inComponent: 0)
         ...
         {  imageLeft.image = UIImage(named: "trenchcoat.png")
            imageRight.image = UIImage(named: "yasang.png")
             labelLeft.text = "트렌치코트"
            labelRight.text = "야상"
